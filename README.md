...
They are written in quarto markdown, rendered to reveal.js, and can be found on the
[`slides` branch](https://github.com/Cambridge-ICCS/intermediate-git/tree/slides).

### Exercises

The exercises for the course can be found in the [slides](https://cambridge-iccs.github.io/intermediate-git).  
